...
pub const AVRational = @import("avcodec.zig").AVRational;
...
pub const struct_AVPacket = @import("avcodec.zig").struct_AVPacket;
...
pub const struct_AVCodecParameters = @import("avcodec.zig").struct_AVCodecParameters;
...
// libavformat/avformat.h:614:9: warning: struct demoted to opaque type - has bitfield
...
pub const LIBAVFORMAT_VERSION_MINOR = @as(c_int, 1);
