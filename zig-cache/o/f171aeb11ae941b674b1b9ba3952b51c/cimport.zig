...
pub const __ENVIRONMENT_OS_VERSION_MIN_REQUIRED__ = @import("std").zig.c_translation.promoteIntLiteral(c_int, 130100, .decimal);
...
pub const MAC_OS_X_VERSION_MAX_ALLOWED = MAC_OS_VERSION_13_3;
