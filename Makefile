...
ZIG_FILES := src/fata_morgana.zig src/text.zig src/maths.zig src/essence.zig src/shapes.zig src/color_magic.zig
...
_build/default/test/test_fata_morgana.exe: $(OCAML_FILES) zig-out/lib/libfata_morgana.dylib
	dune build
