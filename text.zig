...
pub const @"u16" = u16;
pub const @"u8" = u8;
pub const u32vec2 = extern struct {
...
pub const FMVideo = extern struct {
    f: [*c]FILE = @import("std").mem.zeroes([*c]FILE),
    ctx: [*c]AVCodecContext = @import("std").mem.zeroes([*c]AVCodecContext),
    codec: [*c]const AVCodec = @import("std").mem.zeroes([*c]const AVCodec),
    frame: [*c]AVFrame = @import("std").mem.zeroes([*c]AVFrame),
    pkt: [*c]AVPacket = @import("std").mem.zeroes([*c]AVPacket),
    counter: @"u32" = @import("std").mem.zeroes(@"u32"),
};
pub extern fn u8_of_int(x: c_int) @"u8";
pub extern fn u32_of_int(x: c_int) @"u32";
pub export fn rgb2yuv(arg_c: [*c]@"u8") void {
    var c = arg_c;
    _ = &c;
    var t: u8vec3 = undefined;
    _ = &t;
    t.x = @as(@"u8", @intFromFloat(((0.299 * @as(f64, @floatFromInt(@as(c_int, @bitCast(@as(c_uint, c[@as(c_uint, @intCast(@as(c_int, 0)))])))))) + (0.587 * @as(f64, @floatFromInt(@as(c_int, @bitCast(@as(c_uint, c[@as(c_uint, @intCast(@as(c_int, 1)))]))))))) + (0.114 * @as(f64, @floatFromInt(@as(c_int, @bitCast(@as(c_uint, c[@as(c_uint, @intCast(@as(c_int, 2)))]))))))));
    t.y = @as(@"u8", @intFromFloat((((-0.168736 * @as(f64, @floatFromInt(@as(c_int, @bitCast(@as(c_uint, c[@as(c_uint, @intCast(@as(c_int, 0)))])))))) + (-0.331264 * @as(f64, @floatFromInt(@as(c_int, @bitCast(@as(c_uint, c[@as(c_uint, @intCast(@as(c_int, 1)))]))))))) + (0.5 * @as(f64, @floatFromInt(@as(c_int, @bitCast(@as(c_uint, c[@as(c_uint, @intCast(@as(c_int, 2)))]))))))) + @as(f64, @floatFromInt(@as(c_int, 128)))));
    t.z = @as(@"u8", @intFromFloat((((0.5 * @as(f64, @floatFromInt(@as(c_int, @bitCast(@as(c_uint, c[@as(c_uint, @intCast(@as(c_int, 0)))])))))) + (-0.418688 * @as(f64, @floatFromInt(@as(c_int, @bitCast(@as(c_uint, c[@as(c_uint, @intCast(@as(c_int, 1)))]))))))) + (-0.081312 * @as(f64, @floatFromInt(@as(c_int, @bitCast(@as(c_uint, c[@as(c_uint, @intCast(@as(c_int, 2)))]))))))) + @as(f64, @floatFromInt(@as(c_int, 128)))));
    c[@as(c_uint, @intCast(@as(c_int, 0)))] = t.x;
    c[@as(c_uint, @intCast(@as(c_int, 1)))] = t.y;
    c[@as(c_uint, @intCast(@as(c_int, 2)))] = t.z;
}
pub export fn init(arg_name: [*c]u8, arg_width: c_int, arg_height: c_int) [*c]FMVideo {
    var name = arg_name;
    _ = &name;
    var width = arg_width;
    _ = &width;
    var height = arg_height;
    _ = &height;
    var retval: [*c]FMVideo = @as([*c]FMVideo, @ptrCast(@alignCast(malloc(@sizeOf(FMVideo)))));
    _ = &retval;
    if (!(retval != null)) {
        _ = puts("No ram for fmvideo\n");
        exit(@as(c_int, 1));
    }
    var ret: c_int = undefined;
    _ = &ret;
    retval.*.counter = 0;
    var codec_name: [*c]const u8 = "mpeg1video";
    _ = &codec_name;
    retval.*.codec = avcodec_find_encoder_by_name(codec_name);
    if (!(retval.*.codec != null)) {
        _ = fprintf(__stderrp, "Codec '%s' not found\n", codec_name);
        exit(@as(c_int, 1));
    }
    retval.*.ctx = avcodec_alloc_context3(retval.*.codec);
    if (!(retval.*.ctx != null)) {
        _ = fprintf(__stderrp, "Could not allocate video codec context\n");
        exit(@as(c_int, 1));
    }
    retval.*.pkt = av_packet_alloc();
    if (!(retval.*.pkt != null)) {
        _ = fprintf(__stderrp, "Could not allocate video packet\n");
        exit(@as(c_int, 1));
    }
    retval.*.ctx.*.bit_rate = @as(i64, @bitCast(@as(c_longlong, @as(c_int, 400000))));
    retval.*.ctx.*.width = width * @as(c_int, 2);
    retval.*.ctx.*.height = height * @as(c_int, 2);
    retval.*.ctx.*.time_base = AVRational{
        .num = @as(c_int, 1),
        .den = @as(c_int, 25),
    };
    retval.*.ctx.*.framerate = AVRational{
        .num = @as(c_int, 25),
        .den = @as(c_int, 1),
    };
    ...
    if (retval.*.codec.*.id == @as(c_uint, @bitCast(AV_CODEC_ID_H264))) {
        _ = av_opt_set(retval.*.ctx.*.priv_data, "preset", "slow", @as(c_int, 0));
    }
    ret = avcodec_open2(retval.*.ctx, retval.*.codec, null);
    if (ret < @as(c_int, 0)) {
        _ = fprintf(__stderrp, "Could not open codec: %s\n", av_make_error_string(@as([*c]u8, @ptrCast(@alignCast(&([1]u8{
            0,
        } ++ [1]u8{0} ** 63)))), @as(usize, @bitCast(@as(c_long, @as(c_int, 64)))), ret));
        exit(@as(c_int, 1));
    }
    retval.*.f = fopen(name, "wb");
    if (!(retval.*.f != null)) {
        _ = fprintf(__stderrp, "Cloud not open %s\n", name);
        exit(@as(c_int, 1));
    }
    retval.*.frame = av_frame_alloc();
    if (!(retval.*.frame != null)) {
        _ = fprintf(__stderrp, "Could not sllocate video frame\n");
        exit(@as(c_int, 1));
    }
    retval.*.frame.*.format = retval.*.ctx.*.pix_fmt;
    retval.*.frame.*.width = retval.*.ctx.*.width;
    retval.*.frame.*.height = retval.*.ctx.*.height;
    ret = av_frame_get_buffer(retval.*.frame, @as(c_int, 0));
    if (ret < @as(c_int, 0)) {
        _ = fprintf(__stderrp, "Could not allocate the video frame data\n");
        exit(@as(c_int, 1));
    }
    return retval;
}
pub export fn add_frame(arg_v: [*c]FMVideo) void {
    var v = arg_v;
    _ = &v;
    var ret: c_int = undefined;
    _ = &ret;
...
pub export fn encode(arg_v: [*c]FMVideo) void {
    var v = arg_v;
    _ = &v;
    var ret: c_int = undefined;
    _ = &ret;
    v.*.frame.*.pts = @as(i64, @bitCast(@as(c_ulonglong, v.*.counter)));
    ret = avcodec_send_frame(v.*.ctx, v.*.frame);
    if (ret < @as(c_int, 0)) {
        _ = fprintf(__stderrp, "Error sending a frame for encoding\n");
        exit(@as(c_int, 1));
    }
    while (ret >= @as(c_int, 0)) {
        ret = avcodec_receive_packet(v.*.ctx, v.*.pkt);
        if ((ret == -@as(c_int, 35)) or (ret == -@as(c_int, @bitCast(@as(c_uint, @bitCast((@as(c_int, 'E') | (@as(c_int, 'O') << @intCast(8))) | (@as(c_int, 'F') << @intCast(16)))) | (@as(c_uint, @bitCast(@as(c_int, ' '))) << @intCast(24)))))) {
            return;
        } else if (ret < @as(c_int, 0)) {
            _ = fprintf(__stderrp, "Error during encoding\n");
            exit(@as(c_int, 1));
        }
        _ = fwrite(@as(?*const anyopaque, @ptrCast(v.*.pkt.*.data)), @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_ulong, @bitCast(@as(c_long, v.*.pkt.*.size))), v.*.f);
        av_packet_unref(v.*.pkt);
    }
}
pub export fn write_and_close(arg_v: [*c]FMVideo) void {
    var v = arg_v;
    _ = &v;
    var endcode: [4]u8 = [4]u8{
        0,
        0,
        1,
        183,
    ...
    _ = &endcode;
    if ((v.*.codec.*.id == @as(c_uint, @bitCast(AV_CODEC_ID_MPEG1VIDEO))) or (v.*.codec.*.id == @as(c_uint, @bitCast(AV_CODEC_ID_MPEG2VIDEO)))) {
        _ = fwrite(@as(?*const anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@alignCast(&endcode))))), @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf([4]u8), v.*.f);
    }
    _ = fclose(v.*.f);
...
pub export fn circle(arg_v: [*c]FMVideo, arg_pf: [*c]f32, arg_c: [*c]@"u8", arg_r: c_int, arg_w: c_int, arg_t: f32, arg_duration: f32) void {
    var v = arg_v;
    _ = &v;
    var pf = arg_pf;
    _ = &pf;
    ...
    _ = &duration;
    var p: [2]@"i32" = [2]@"i32"{
        @as(@"i32", @intFromFloat(((@as(f64, @floatCast(pf[@as(c_uint, @intCast(@as(c_int, 0)))])) + 1.0) * @as(f64, @floatFromInt(v.*.ctx.*.width))) / 2.0)),
        @as(@"i32", @intFromFloat(((1.0 - @as(f64, @floatCast(pf[@as(c_uint, @intCast(@as(c_int, 0)))]))) * @as(f64, @floatFromInt(v.*.ctx.*.height))) / 2.0)),
    };
    _ = &p;
    var nframes: f32 = (duration * @as(f32, @floatFromInt(v.*.ctx.*.framerate.num))) / @as(f32, @floatFromInt(v.*.ctx.*.framerate.den));
    _ = &nframes;
    var curframe: f32 = (t * @as(f32, @floatFromInt(v.*.ctx.*.framerate.num))) / @as(f32, @floatFromInt(v.*.ctx.*.framerate.den));
    _ = &curframe;
    var linesize: [*c]c_int = @as([*c]c_int, @ptrCast(@alignCast(&v.*.frame.*.linesize)));
    _ = &linesize;
    var height: c_int = v.*.ctx.*.height;
    _ = &height;
    var width: c_int = v.*.ctx.*.width;
    _ = &width;
    var bgc: [3]@"u8" = undefined;
    _ = &bgc;
    {
        var x: c_int = if (((p[@as(c_uint, @intCast(@as(c_int, 0)))] - r) - w) > @as(c_int, 0)) (p[@as(c_uint, @intCast(@as(c_int, 0)))] - r) - w else @as(c_int, 0);
        _ = &x;
        while (x < (if (width < ((p[@as(c_uint, @intCast(@as(c_int, 0)))] + r) + w)) width else (p[@as(c_uint, @intCast(@as(c_int, 0)))] + r) + w)) : (x += 1) {
            {
                var y: c_int = if (((p[@as(c_uint, @intCast(@as(c_int, 1)))] - r) - w) > @as(c_int, 0)) (p[@as(c_uint, @intCast(@as(c_int, 1)))] - r) - w else @as(c_int, 0);
                _ = &y;
                while (y < (if (height < ((p[@as(c_uint, @intCast(@as(c_int, 1)))] + r) + w)) height else (p[@as(c_uint, @intCast(@as(c_int, 1)))] + r) + w)) : (y += 1) {
                    var sm: [3]f32 = [3]f32{
                        0,
                        0,
                        0,
                    ...
                    _ = &out_counter;
                    bgc[@as(c_uint, @intCast(@as(c_int, 0)))] = (blk: {
                        const tmp = (y * linesize[@as(c_uint, @intCast(@as(c_int, 0)))]) + x;
                        if (tmp >= 0) break :blk v.*.frame.*.data[@as(c_uint, @intCast(@as(c_int, 0)))] + @as(usize, @intCast(tmp)) else break :blk v.*.frame.*.data[@as(c_uint, @intCast(@as(c_int, 0)))] - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*;
                    bgc[@as(c_uint, @intCast(@as(c_int, 1)))] = (blk: {
                        const tmp = (@divTrunc(y, @as(c_int, 2)) * linesize[@as(c_uint, @intCast(@as(c_int, 1)))]) + @divTrunc(x, @as(c_int, 2));
                        if (tmp >= 0) break :blk v.*.frame.*.data[@as(c_uint, @intCast(@as(c_int, 1)))] + @as(usize, @intCast(tmp)) else break :blk v.*.frame.*.data[@as(c_uint, @intCast(@as(c_int, 1)))] - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*;
                    bgc[@as(c_uint, @intCast(@as(c_int, 2)))] = (blk: {
                        const tmp = (@divTrunc(y, @as(c_int, 2)) * linesize[@as(c_uint, @intCast(@as(c_int, 2)))]) + @divTrunc(x, @as(c_int, 2));
                        if (tmp >= 0) break :blk v.*.frame.*.data[@as(c_uint, @intCast(@as(c_int, 2)))] + @as(usize, @intCast(tmp)) else break :blk v.*.frame.*.data[@as(c_uint, @intCast(@as(c_int, 2)))] - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*;
                    if (((((((@as(f64, @floatFromInt(x)) + 0.25) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 0)))]))) * ((@as(f64, @floatFromInt(x)) + 0.25) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 0)))])))) + (((@as(f64, @floatFromInt(y)) + 0.125) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 1)))]))) * ((@as(f64, @floatFromInt(y)) + 0.125) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 1)))]))))) >= @as(f64, @floatFromInt((r - w) * (r - w)))) and (((((@as(f64, @floatFromInt(x)) + 0.25) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 0)))]))) * ((@as(f64, @floatFromInt(x)) + 0.25) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 0)))])))) + (((@as(f64, @floatFromInt(y)) + 0.125) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 1)))]))) * ((@as(f64, @floatFromInt(y)) + 0.125) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 1)))]))))) <= @as(f64, @floatFromInt((r + w) * (r + w))))) and (@as(f64, @floatCast(vector_angle(@as(c_int, @intFromFloat((@as(f64, @floatFromInt(x)) + 0.25) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 0)))])))), @as(c_int, @intFromFloat((@as(f64, @floatFromInt(y)) + 0.125) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 1)))]))))))) <= ((@as(f64, @floatCast(@as(f32, @floatFromInt(@as(c_int, 2))) * curframe)) * 3.141592653589793) / @as(f64, @floatCast(nframes))))) {
                        sm[@as(c_uint, @intCast(@as(c_int, 0)))] += 0.25 * @as(f64, @floatFromInt(@as(c_int, @bitCast(@as(c_uint, c[@as(c_uint, @intCast(@as(c_int, 0)))])))));
                        sm[@as(c_uint, @intCast(@as(c_int, 1)))] += 0.25 * @as(f64, @floatFromInt(@as(c_int, @bitCast(@as(c_uint, c[@as(c_uint, @intCast(@as(c_int, 1)))])))));
                        sm[@as(c_uint, @intCast(@as(c_int, 2)))] += 0.25 * @as(f64, @floatFromInt(@as(c_int, @bitCast(@as(c_uint, c[@as(c_uint, @intCast(@as(c_int, 2)))])))));
                    } else {
                        out_counter +%= 1;
                        sm[@as(c_uint, @intCast(@as(c_int, 0)))] += 0.25 * @as(f64, @floatFromInt(@as(c_int, @bitCast(@as(c_uint, bgc[@as(c_uint, @intCast(@as(c_int, 0)))])))));
                        sm[@as(c_uint, @intCast(@as(c_int, 1)))] += 0.25 * @as(f64, @floatFromInt(@as(c_int, @bitCast(@as(c_uint, bgc[@as(c_uint, @intCast(@as(c_int, 1)))])))));
                        sm[@as(c_uint, @intCast(@as(c_int, 2)))] += 0.25 * @as(f64, @floatFromInt(@as(c_int, @bitCast(@as(c_uint, bgc[@as(c_uint, @intCast(@as(c_int, 2)))])))));
                    }
                    if (((((((@as(f64, @floatFromInt(x)) + 0.125) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 0)))]))) * ((@as(f64, @floatFromInt(x)) + 0.125) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 0)))])))) + (((@as(f64, @floatFromInt(y)) + 0.75) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 1)))]))) * ((@as(f64, @floatFromInt(y)) + 0.75) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 1)))]))))) >= @as(f64, @floatFromInt((r - w) * (r - w)))) and (((((@as(f64, @floatFromInt(x)) + 0.125) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 0)))]))) * ((@as(f64, @floatFromInt(x)) + 0.125) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 0)))])))) + (((@as(f64, @floatFromInt(y)) + 0.75) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 1)))]))) * ((@as(f64, @floatFromInt(y)) + 0.75) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 1)))]))))) <= @as(f64, @floatFromInt((r + w) * (r + w))))) and (@as(f64, @floatCast(vector_angle(@as(c_int, @intFromFloat((@as(f64, @floatFromInt(x)) + 0.125) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 0)))])))), @as(c_int, @intFromFloat((@as(f64, @floatFromInt(y)) + 0.75) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 1)))]))))))) <= ((@as(f64, @floatCast(@as(f32, @floatFromInt(@as(c_int, 2))) * curframe)) * 3.141592653589793) / @as(f64, @floatCast(nframes))))) {
                        sm[@as(c_uint, @intCast(@as(c_int, 0)))] += 0.25 * @as(f64, @floatFromInt(@as(c_int, @bitCast(@as(c_uint, c[@as(c_uint, @intCast(@as(c_int, 0)))])))));
                        sm[@as(c_uint, @intCast(@as(c_int, 1)))] += 0.25 * @as(f64, @floatFromInt(@as(c_int, @bitCast(@as(c_uint, c[@as(c_uint, @intCast(@as(c_int, 1)))])))));
                        sm[@as(c_uint, @intCast(@as(c_int, 2)))] += 0.25 * @as(f64, @floatFromInt(@as(c_int, @bitCast(@as(c_uint, c[@as(c_uint, @intCast(@as(c_int, 2)))])))));
                    } else {
                    ...
                    if (((((((@as(f64, @floatFromInt(x)) + 0.75) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 0)))]))) * ((@as(f64, @floatFromInt(x)) + 0.75) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 0)))])))) + (((@as(f64, @floatFromInt(y)) + 0.875) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 1)))]))) * ((@as(f64, @floatFromInt(y)) + 0.875) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 1)))]))))) >= @as(f64, @floatFromInt((r - w) * (r - w)))) and (((((@as(f64, @floatFromInt(x)) + 0.75) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 0)))]))) * ((@as(f64, @floatFromInt(x)) + 0.75) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 0)))])))) + (((@as(f64, @floatFromInt(y)) + 0.875) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 1)))]))) * ((@as(f64, @floatFromInt(y)) + 0.875) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 1)))]))))) <= @as(f64, @floatFromInt((r + w) * (r + w))))) and (@as(f64, @floatCast(vector_angle(@as(c_int, @intFromFloat((@as(f64, @floatFromInt(x)) + 0.75) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 0)))])))), @as(c_int, @intFromFloat((@as(f64, @floatFromInt(y)) + 0.825) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 1)))]))))))) <= ((@as(f64, @floatCast(@as(f32, @floatFromInt(@as(c_int, 2))) * curframe)) * 3.141592653589793) / @as(f64, @floatCast(nframes))))) {
                        sm[@as(c_uint, @intCast(@as(c_int, 0)))] += 0.25 * @as(f64, @floatFromInt(@as(c_int, @bitCast(@as(c_uint, c[@as(c_uint, @intCast(@as(c_int, 0)))])))));
                        sm[@as(c_uint, @intCast(@as(c_int, 1)))] += 0.25 * @as(f64, @floatFromInt(@as(c_int, @bitCast(@as(c_uint, c[@as(c_uint, @intCast(@as(c_int, 1)))])))));
                        sm[@as(c_uint, @intCast(@as(c_int, 2)))] += 0.25 * @as(f64, @floatFromInt(@as(c_int, @bitCast(@as(c_uint, c[@as(c_uint, @intCast(@as(c_int, 2)))])))));
                    } else {
                    ...
                    if (((((((@as(f64, @floatFromInt(x)) + 0.875) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 0)))]))) * ((@as(f64, @floatFromInt(x)) + 0.875) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 0)))])))) + (((@as(f64, @floatFromInt(y)) + 0.25) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 1)))]))) * ((@as(f64, @floatFromInt(y)) + 0.25) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 1)))]))))) >= @as(f64, @floatFromInt((r - w) * (r - w)))) and (((((@as(f64, @floatFromInt(x)) + 0.875) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 0)))]))) * ((@as(f64, @floatFromInt(x)) + 0.875) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 0)))])))) + (((@as(f64, @floatFromInt(y)) + 0.25) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 1)))]))) * ((@as(f64, @floatFromInt(y)) + 0.25) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 1)))]))))) <= @as(f64, @floatFromInt((r + w) * (r + w))))) and (@as(f64, @floatCast(vector_angle(@as(c_int, @intFromFloat((@as(f64, @floatFromInt(x)) + 0.875) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 0)))])))), @as(c_int, @intFromFloat((@as(f64, @floatFromInt(y)) + 0.25) - @as(f64, @floatFromInt(p[@as(c_uint, @intCast(@as(c_int, 1)))]))))))) <= ((@as(f64, @floatCast(@as(f32, @floatFromInt(@as(c_int, 2))) * curframe)) * 3.141592653589793) / @as(f64, @floatCast(nframes))))) {
                        sm[@as(c_uint, @intCast(@as(c_int, 0)))] += 0.25 * @as(f64, @floatFromInt(@as(c_int, @bitCast(@as(c_uint, c[@as(c_uint, @intCast(@as(c_int, 0)))])))));
                        sm[@as(c_uint, @intCast(@as(c_int, 1)))] += 0.25 * @as(f64, @floatFromInt(@as(c_int, @bitCast(@as(c_uint, c[@as(c_uint, @intCast(@as(c_int, 1)))])))));
                        sm[@as(c_uint, @intCast(@as(c_int, 2)))] += 0.25 * @as(f64, @floatFromInt(@as(c_int, @bitCast(@as(c_uint, c[@as(c_uint, @intCast(@as(c_int, 2)))])))));
                    } else {
                    ...
                    if (@as(c_int, @bitCast(@as(c_uint, out_counter))) == @as(c_int, 4)) {
                        continue;
                    }
                    if ((((((sm[@as(c_uint, @intCast(@as(c_int, 0)))] > @as(f32, @floatFromInt(@as(c_int, 255)))) or (sm[@as(c_uint, @intCast(@as(c_int, 1)))] > @as(f32, @floatFromInt(@as(c_int, 255))))) or (sm[@as(c_uint, @intCast(@as(c_int, 2)))] > @as(f32, @floatFromInt(@as(c_int, 255))))) or (sm[@as(c_uint, @intCast(@as(c_int, 0)))] < @as(f32, @floatFromInt(-@as(c_int, 255))))) or (sm[@as(c_uint, @intCast(@as(c_int, 1)))] < @as(f32, @floatFromInt(-@as(c_int, 255))))) or (sm[@as(c_uint, @intCast(@as(c_int, 2)))] < @as(f32, @floatFromInt(-@as(c_int, 255))))) {
                        _ = printf("%f, %f, %f\n", @as(f64, @floatCast(sm[@as(c_uint, @intCast(@as(c_int, 0)))])), @as(f64, @floatCast(sm[@as(c_uint, @intCast(@as(c_int, 1)))])), @as(f64, @floatCast(sm[@as(c_uint, @intCast(@as(c_int, 2)))])));
                    }
                    (blk: {
                        const tmp = (y * linesize[@as(c_uint, @intCast(@as(c_int, 0)))]) + x;
                        if (tmp >= 0) break :blk v.*.frame.*.data[@as(c_uint, @intCast(@as(c_int, 0)))] + @as(usize, @intCast(tmp)) else break :blk v.*.frame.*.data[@as(c_uint, @intCast(@as(c_int, 0)))] - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).* = @as(u8, @intFromFloat(sm[@as(c_uint, @intCast(@as(c_int, 0)))]));
                    if (((x & @as(c_int, 1)) == @as(c_int, 0)) and ((y & @as(c_int, 1)) == @as(c_int, 0))) {
                        (blk: {
                            const tmp = (@divTrunc(y, @as(c_int, 2)) * linesize[@as(c_uint, @intCast(@as(c_int, 1)))]) + @divTrunc(x, @as(c_int, 2));
                            if (tmp >= 0) break :blk v.*.frame.*.data[@as(c_uint, @intCast(@as(c_int, 1)))] + @as(usize, @intCast(tmp)) else break :blk v.*.frame.*.data[@as(c_uint, @intCast(@as(c_int, 1)))] - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).* = @as(u8, @intFromFloat(sm[@as(c_uint, @intCast(@as(c_int, 1)))]));
                        (blk: {
                            const tmp = (@divTrunc(y, @as(c_int, 2)) * linesize[@as(c_uint, @intCast(@as(c_int, 2)))]) + @divTrunc(x, @as(c_int, 2));
                            if (tmp >= 0) break :blk v.*.frame.*.data[@as(c_uint, @intCast(@as(c_int, 2)))] + @as(usize, @intCast(tmp)) else break :blk v.*.frame.*.data[@as(c_uint, @intCast(@as(c_int, 2)))] - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).* = @as(u8, @intFromFloat(sm[@as(c_uint, @intCast(@as(c_int, 2)))]));
                    }
                }
            }
        }
...
pub extern fn write_text(v: [*c]FMVideo, p: [*c]f32, c: [*c]@"u8", fgc: [*c]@"u8", str: [*c]@"u32", len: c_int, frames: c_int, frame: c_int, size: c_int) void;
pub export fn paint_background(arg_v: [*c]FMVideo, arg_bgc: [*c]@"u8") void {
    var v = arg_v;
    _ = &v;
    var bgc = arg_bgc;
    _ = &bgc;
    ...
    _ = &linesize;
    {
        var y: c_int = 0;
        _ = &y;
        while (y < v.*.ctx.*.height) : (y += 1) {
            {
                var x: c_int = 0;
                _ = &x;
                while (x < v.*.ctx.*.width) : (x += 1) {
                    (blk: {
                        const tmp = (y * linesize[@as(c_uint, @intCast(@as(c_int, 0)))]) + x;
                        if (tmp >= 0) break :blk v.*.frame.*.data[@as(c_uint, @intCast(@as(c_int, 0)))] + @as(usize, @intCast(tmp)) else break :blk v.*.frame.*.data[@as(c_uint, @intCast(@as(c_int, 0)))] - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).* = bgc[@as(c_uint, @intCast(@as(c_int, 0)))];
                    (blk: {
                        const tmp = (@divTrunc(y, @as(c_int, 2)) * linesize[@as(c_uint, @intCast(@as(c_int, 1)))]) + @divTrunc(x, @as(c_int, 2));
                        if (tmp >= 0) break :blk v.*.frame.*.data[@as(c_uint, @intCast(@as(c_int, 1)))] + @as(usize, @intCast(tmp)) else break :blk v.*.frame.*.data[@as(c_uint, @intCast(@as(c_int, 1)))] - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).* = bgc[@as(c_uint, @intCast(@as(c_int, 1)))];
                    (blk: {
                        const tmp = (@divTrunc(y, @as(c_int, 2)) * linesize[@as(c_uint, @intCast(@as(c_int, 2)))]) + @divTrunc(x, @as(c_int, 2));
                        if (tmp >= 0) break :blk v.*.frame.*.data[@as(c_uint, @intCast(@as(c_int, 2)))] + @as(usize, @intCast(tmp)) else break :blk v.*.frame.*.data[@as(c_uint, @intCast(@as(c_int, 2)))] - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).* = bgc[@as(c_uint, @intCast(@as(c_int, 2)))];
                }
            }
        }
    }
}
pub extern fn vector_angle(x: c_int, y: c_int) f32;
...
pub const FM_VIDEO_H = "";
pub const RUSTY_INT_H = "";
pub const FMMATH_H = "";
